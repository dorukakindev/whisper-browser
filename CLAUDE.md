...
- **Senkron ():** ffsubsync ile aynı çekirdek (ses enerjisi VAD sinyali ↔ altyazı gösterim sinyali, FFT çapraz-korelasyon). Ek olarak  bilinen framerate oranlarını () tek tek deneyip **normalize korelasyon skoru** en yüksek olanı seçer; oran 1.0 dışına ancak skor %8+ iyileşirse çıkar (gürültüye kanmasın).  skor döndürür — farklı adayları kıyaslamak için şart.
