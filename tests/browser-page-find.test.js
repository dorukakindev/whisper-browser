...
assert.equal(wc.calls[0].options.findNext, false, 'Electron ilk istekte yeni arama oturumu başlatmalı');
...
assert.equal(wc.calls.at(-1).options.findNext, false, 'yeni metin mevcut arama oturumunu taşımamalı');
