Güncel çalışma: [2026-09-22 16:44 — TR çeviri sentence-group dağıtım kapıları: erken-sonu kapısı iç-cümle kotalı hale geldi ("Bekle." artık kabul), parça başına sayı/özel-ad/SDH demirleme + açık bağlantı + tekrar kapıları, sertleştirilmiş son kurtarma promptu, cue içi ikinci cümleye gerçek \n; 24 yeni test, canlı koşu kanıtlı; BROWSER_BUG_REPORT_108](docs/devir/2026-09-22-1644.md).
