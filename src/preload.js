...
contextBridge.exposeInMainWorld('api', {
  ...
  addBrowserExtension: () => ipcRenderer.invoke('browser:extensions:add'),
  toggleBrowserExtension: (id, enabled) => ipcRenderer.invoke('browser:extensions:toggle', id, enabled),
  openBrowserExtension: (id) => ipcRenderer.invoke('browser:extensions:open', id),
  removeBrowserExtension: (id) => ipcRenderer.invoke('browser:extensions:remove', id),
