...
contextBridge.exposeInMainWorld('api', {
  ...
  startBrowserTranslation: (tabId, payload) => ipcRenderer.invoke('browser:translation:start', { tabId, ...payload }),
  ...
  startBrowserLiveAsr: (tabId, options) => ipcRenderer.invoke('browser:liveAsr:start', { tabId, ...options }),
  sendBrowserLiveAsrChunk: (tabId, payload) => ipcRenderer.invoke('browser:liveAsr:chunk', { tabId, ...payload }),
