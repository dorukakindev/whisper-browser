...
const BUILTIN_ADAPTER_DEFINITIONS = Object.freeze([
  ...
  { id: 'hulu', label: 'Hulu', hosts: ['hulu.com', 'hulu.jp'], responseHint: /caption|subtitle|texttrack|webvtt|ttml|dfxp|sami|\/v\d+\/playlist(?:[/?#\s]|$)|\.vtt|\.m3u8|\.mpd/i, help: 'Videoyu başlatın ve Hulu oynatıcısında kaynak altyazıyı açın.' },
