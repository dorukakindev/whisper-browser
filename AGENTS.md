...
- Denetim/bug bulguları **her zaman bir `.md` dosyasına** kaydedilir; yalnız sohbette bırakma. Raporlar kökte DEĞİL `docs/raporlar/` altında tutulur (kök yalnız README, CHANGELOG, katkı/güvenlik ve tasarım sözleşmesi belgeleri içindir). Seri `BROWSER_BUG_REPORT_<sıra>.md` adlandırmasını izle (son: 105).
